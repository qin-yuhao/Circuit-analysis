...
# python为这些方法的实现提供了很大的便利,
# 如:列表就可以直接当作是一个队列或者栈,
# 字典就能存储一张图的结构

# python provides great convenience for implementing these methods,

# For example, a list can be directly treated as a queue or stack.

# The # dictionary stores the structure of a graph
